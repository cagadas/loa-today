<template>
  <q-page class="flex-center">
    ...
    <p>At LOA Today Podcasts, one of our main priorities is the privacy of our visitors. 
      ...
      by LOA Today Podcasts and how we use it.</p>
    <p>If you have additional questions or require more information about our Privacy Policy, 
      do not hesitate to contact us.</p>
    <h6>Encryption</h6>
    <p>We use industry-standard encryption at all times to deliver content to your device.</p>
    <h6>Log Files</h6>
    <p>LOA Today Podcasts follows a standard procedure of using log files. These files log 
      visitors when they use apps or visit websites. All hosting companies do this as a part of hosting 
      ...
      <p>Some of advertisers on our site may use cookies and web beacons. Our advertising 
        ...
        <p>LOA Today Podcasts's Privacy Policy does not apply to other apps or websites. 
          Thus, we are advising you to consult the respective Privacy Policies of these 
          third-party ad servers for more detailed information. They may include their practices 
        ...
        <p>LOA Today Podcasts does not knowingly collect any Personal Identifiable Information 
          from children under the age of 13. If you think that your child provided this kind of 
          information in our app or on our website, we strongly encourage you to contact us 
          immediately, and we will do our best efforts to promptly remove such information from 
          our records.</p>
        <h6>Online Privacy Policy Only</h6>
        <p>This Privacy Policy applies only to our online activities and is valid for users of
          this app with regards to the information that they shared and/or collect in LOA Today 
          Podcasts. This policy is not applicable to any information collected offline or via 
          channels other than this app.</p>
        <h6>Consent</h6>

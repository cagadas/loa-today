<template>
  <q-page class="flex-center">
    ...
    <p>By accessing this website we assume you accept these terms and conditions. Do not 
      continue to use LOA Today Podcasts if you do not agree to take all of the terms and 
      conditions stated on this page. Our Terms and Conditions were created with the help 
      of the Terms & Conditions Generator Online and the Free Terms &amp; Conditions Generator.</p>
    <p>The following terminology applies to these Terms and Conditions, Privacy Statement 
      ...
      of meeting the Client’s needs in respect of provision of the Company’s stated services, 
    ...
    <h6>Cookies</h6>
    <p>We employ the use of cookies. By accessing LOA Today Podcasts, you agreed to use cookies
      in agreement with the LOA Today Podcasts's Privacy Policy.</p>
    ...
    <h6>License</h6>
    <p>Unless otherwise stated, LOA Today Podcasts and/or its licensors own the intellectual 
      property rights for all material on LOA Today Podcasts. All intellectual property rights 
      are reserved. You may access this from LOA Today Podcasts for your own personal use 
      subjected to restrictions set in these terms and conditions.</p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from LOA Today Podcasts</li>
      <li>Sell, rent or sub-license material from LOA Today Podcasts</li>
      <li>Reproduce, duplicate or copy material from LOA Today Podcasts</li>
      <li>Redistribute content from LOA Today Podcasts</li>
      <li>This Agreement shall begin on the date hereof.</li>
    </ul>
    <p>Parts of this website offer an opportunity for users to post and exchange opinions 
      and information in certain areas of the website. LOA Today Podcasts does not filter, 
      edit, publish or review Comments prior to their presence on the website. Comments do 
      not reflect the views and opinions of LOA Today Podcasts,its agents and/or affiliates. 
      Comments reflect the views and opinions of the person who post their views and opinions. 
      To the extent permitted by applicable laws, LOA Today Podcasts shall not be liable for 
    ...
    <p>LOA Today Podcasts reserves the right to monitor all Comments and to remove any Comments 
    ...
    <ul>
      ...
      <li>You hereby grant LOA Today Podcasts a non-exclusive license to use, reproduce, 
        edit and authorize others to use, reproduce and edit any of your Comments in any and 
        all forms, formats or media.</li>
    </ul>
    ...
    <ul>
      ...
      <li>(b) does not falsely imply sponsorship, endorsement or approval of the linking 
        party and its products and/or services; and</li>
    ...
    <ul>
      <li>(a) the link would not make us look unfavorably to ourselves or to our accredited 
        businesses;</li>
      <li>(b) the organization does not have any negative records with us;</li>
      <li>(c) the benefit to us from the visibility of the hyperlink compensates the absence 
        of LOA Today Podcasts; and (d) the link is in the context of general resource information.</li>
    </ul>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in 
      linking to our website, you must inform us by sending an e-mail to LOA Today Podcasts. 
    ...
    <p>No use of LOA Today Podcasts's logo or other artwork will be allowed for linking absent 
      a trademark license agreement.</p>
    <h6>iFrames</h6>
    <p>Without prior approval and written permission, you may not create frames around our 
      app pages that alter in any way the visual presentation or appearance of our app.</p>
    ...
    <p>We reserve the right to request that you remove all links or any particular link to our 
      app. You approve to immediately remove all links to our app upon request. We also reserve 
      the right to amen these terms and conditions and it’s linking policy at any time. By 
      continuously linking to our app, you agree to be bound to and follow these linking terms 
      and conditions.</p>
    ...
    <p>We do not ensure that the information on this website is correct, we do not warrant 
      its completeness or accuracy; nor do we promise to ensure that the website remains available 
    ...
    <ul>
      ...
      <li>(b) govern all liabilities arising under the disclaimer, including liabilities arising 
        in contract, in tort and for breach of statutory duty.</li>
    </ul>
